...
class Ui_TalkWindow(object):        
    def setupUi(self, TalkWindow):
        TalkWindow.setObjectName("TalkWindow")      # MainWindow 의 objectName 속성: TalkWindow.
        TalkWindow.resize(300, 300)     # window 창 크기: 300x300.
        self.centralwidget = QtWidgets.QWidget(TalkWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.centralwidget)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.verticalLayout = QtWidgets.QVBoxLayout()       # vertical layout.
        ...
        self.horizontalLayout = QtWidgets.QHBoxLayout()     # horizontal layout.
